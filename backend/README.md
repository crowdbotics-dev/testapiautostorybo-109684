...
## Project Structure
    ...
    ├── testapiautostorybo_109684  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_109684`
...
2. Clone this repo and `cd testapiautostorybo_109684`
